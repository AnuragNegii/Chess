...
public class Game : MonoBehaviour
{
    ...
    //positions in team for each chess piece
    ...
    public void Start(){
        playerWhite  = new GameObject[]{
            ...
            Create("white_knight", 6, 0),Create("white_rook", 7, 0), Create("white_pawn", 1, 1),
            Create("white_pawn", 2, 1), Create("white_pawn", 3, 1), Create("white_pawn", 4, 1),
            Create("white_pawn", 5, 1),Create("white_pawn", 6, 1),Create("white_pawn", 7, 1),Create("white_pawn", 0, 1),
        };
